...
MQ2DMotionValidator::MQ2DMotionValidator(const ompl::base::SpaceInformationPtr &si, unsigned int dim, double vMax)
        : MotionValidator(si), stateSpace_(si_->getStateSpace().get()), vMax_(vMax), vectorStateSpace_(dim) {}

bool MQ2DMotionValidator::checkMotion(const ompl::base::State *s1, const ompl::base::State *s2) const {
...
bool MQ2DMotionValidator::checkMotion(const ompl::base::State *s1, const ompl::base::State *s2,
